...
<?php $__env->startSection('title', 'รายการที่เสร็จสมบูรณ์'); ?>
        ...
        <div class="container">
            <form action="" method="post">
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-auto">
                        <a href="/cash1"><button type="button" class="btn btn-secondary"
                                style="background-color: #6c757d" value="find" onclick="find"><img
                                    src="<?php echo e(URL('image/printer.png')); ?>" style="width: 35px; height: 30px;">
                                รายงานการสั่งจ่าย
                            </button></a>
                    </div>
                    <!-- วันที่สร้าง -->
                    ...
                    <!-- reload -->
                    <div class="col-auto">
                        <a href="/cash3"><img src="<?php echo e(URL('image/reload.png')); ?>"
                    ...
                    <div class="col-auto">
                        <a href="/cash1"><button type="button" class="btn btn-success"
                                style="background-color: #198754" value="find" onclick="find"><img
                                    src="<?php echo e(URL('image/database.png')); ?>" style="width: 35px; height: 30px;">
                                DATA LOAD
                            </button></a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\petty-cash-project\resources\views/cash3.blade.php ENDPATH**/ ?>