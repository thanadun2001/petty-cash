        ...
        <div class="container">
            <form action="" method="post">
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <!-- reload -->
                    <div class="col-auto">
                        <a href=""><img src="<?php echo e(URL('image/reload.png')); ?>"
                                style="width: 35px; height: 30px;"></a>
                    </div>
                    <!-- กดเพื่อเข้าหน้าสร้างใบเงินสดย่อย -->
                    <div class="col-auto">
                        <a href="/adddata"><img src="<?php echo e(URL('image/add.png')); ?>"
                                style="width: 35px; height: 30px;"></a>
                    </div>
                    <div class="col-auto">
                        <label for="exampleFormControlInput1" class="form-label"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\petty-cash-project\resources\views/cash2.blade.php ENDPATH**/ ?>