                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" style="background-color: #287abc;">
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(auth()->user()->role == 'adminle1'): ?>
                            ...
                            <?php elseif(auth()->user()->role == 'adminle2'): ?>
                            ...
                            <?php elseif(auth()->user()->role == 'views'): ?>
                                <li><a class="dropdown-item" href="/cash3"
                                        style="color: white;">04.รายการที่สมบูรณ์แล้ว</a>
                                </li>
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\petty-cash-project\resources\views/layouts/nav.blade.php ENDPATH**/ ?>